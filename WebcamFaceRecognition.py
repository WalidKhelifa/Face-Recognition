...
mhd_image = face_recognition.load_image_file('images/testing/mahmoud.jpg')
mhd_face_encodings = face_recognition.face_encodings(mhd_image)[0]

#save the encodings and the corresponding labels in seperate arrays in the same order
known_face_encodings = [walid_face_encodings,kenzo_face_encodings,mhd_face_encodings]
known_face_names = ["Walid Khelifa","Yacine Kenzo","Saighi Mahmoud"]
...
while True:
    ...
    #display the video
    cv2.imshow("Webcam Video Face Identified",current_frame)
